...
namespace XStoreApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<BestbuyApiConfig>(Configuration.GetSection("BestbuyApi"));
            ...
            services.AddTransient<IBestbuyServiceContext, BestbuyService>();

            services.AddTransient<IRepositoryRest, XStoreRepository>();
